...
Le indicamos que queremos instalar tambien apache y php.\

**ENV** Le indicamos que no queremos que pregunte nada al instalar
**EXPOSE** Le indica a docker que exponga el puerto 80\ 
**ENTRYPOINT** Le indica a Docker cuales son los comandos a ejecutar apenas inicia Docker. En este caso que arranque el servicio de apache

![label text](imgs/01.png)

Al construir la imagen nos arrojo error. Donde dice <None>

![label text](imgs/02.png)

En esta ocacion filtramos por todas las que aparezcan con <none> con "dangling=true" obtenemos el identificador de todas y procedemos a borrar.
...
Con el comando -p80:80 le indicamos a Docker que queremos que el puerto 80 sea igual al nuestro
